...
class DeleteAlertUseCase @Inject constructor(private val repository: AlertsRepository) {
    suspend operator fun invoke(alert: AlertEntity) = repository.deleteAlert(alert)
}